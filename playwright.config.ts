...
const localMarketingPort = process.env.PLAYWRIGHT_MARKETING_PORT ?? "3100";
const localPatientPort = process.env.PLAYWRIGHT_PATIENT_PORT ?? "5174";
...
export default defineConfig({
  ...
  webServer: externalMarketingBaseURL || externalPatientBaseURL
    ...
    : [
        ...
        {
          command: `npm run patient:preview -- --host 127.0.0.1 --port ${localPatientPort}`,
          env: {
            ...process.env,
