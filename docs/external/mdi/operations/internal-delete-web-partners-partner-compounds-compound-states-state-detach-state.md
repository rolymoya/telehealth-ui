# DELETE /web/partners/:partner/compounds/:compound/states/:state

Generated from `docs/external/MD Integrations API.postman_collection.json`. The raw Postman collection remains authoritative.

## Index

- Operation slug: `internal-delete-web-partners-partner-compounds-compound-states-state-detach-state`
- Surface: `internal`
- Method: `DELETE`
