# POST /partner/cases/:case_id/orders/:order_id/submit

Generated from `docs/external/MD Integrations API.postman_collection.json`. The raw Postman collection remains authoritative.

## Index

- Operation slug: `partner-post-partner-cases-case-id-orders-order-id-submit-submit-case-order`
- Surface: `partner`
- Method: `POST`
- Path: `/partner/cases/:case_id/orders/:order_id/submit`
- Raw URL template: `{{baseUrl}}/partner/cases/:case_id/orders/:order_id/submit`
