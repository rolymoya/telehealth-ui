# DELETE /web/partners/:partner/questionnaires/:questionnaire/questions/:question/options/:option

Generated from `docs/external/MD Integrations API.postman_collection.json`. The raw Postman collection remains authoritative.

## Index

- Operation slug: `internal-delete-web-partners-partner-questionnaires-questionnaire-questions-question-options-option-delete-option`
- Surface: `internal`
- Method: `DELETE`
