...
- Operation slug: `webhook-post-case-change-chargeable-amount-charge`
- Surface: `webhook`
- Method: `POST`
- Path: `/`
- Raw URL template: `https://webhook.site`
- Source folders: `Webhooks` / `Case` / `Charges`
- Source request: `Case Change Chargeable Amount Charge`
