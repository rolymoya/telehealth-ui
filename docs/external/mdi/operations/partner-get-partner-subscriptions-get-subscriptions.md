...
- Operation slug: `partner-get-partner-subscriptions-get-subscriptions`
- Surface: `partner`
- Method: `GET`
- Path: `/partner/subscriptions`
- Raw URL template: `{{url}}/partner/subscriptions?page=REDACTED_SCALAR&per_page=REDACTED_SCALAR`
