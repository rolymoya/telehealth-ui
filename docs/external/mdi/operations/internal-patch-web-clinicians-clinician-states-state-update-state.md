# PATCH /web/clinicians/:clinician/states/:state

Generated from `docs/external/MD Integrations API.postman_collection.json`. The raw Postman collection remains authoritative.

## Index

- Operation slug: `internal-patch-web-clinicians-clinician-states-state-update-state`
- Surface: `internal`
- Method: `PATCH`
