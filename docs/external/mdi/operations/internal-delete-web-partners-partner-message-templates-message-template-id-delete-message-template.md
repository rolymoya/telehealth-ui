...
- Operation slug: `internal-delete-web-partners-partner-message-templates-message-template-id-delete-message-template`
- Surface: `internal`
- Method: `DELETE`
...
- Source request: `Delete Message Template`
